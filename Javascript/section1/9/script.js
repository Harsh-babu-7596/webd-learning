const mystring = "harsh";

let news;

news = mystring[0].toUpperCase();

console.log(news + mystring.substring(1));


// going forward with lectures 11
// in next it is 12th as per his git regarding numbers and their functions
